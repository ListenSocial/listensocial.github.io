...
function getTwitterService() {
  return OAuth2.createService('Twitter')
    ...
    .setClientId(PropertiesService.getScriptProperties().getProperty('TWITTER_API_KEY'))
    .setClientSecret(PropertiesService.getScriptProperties().getProperty('TWITTER_API_SECRET_KEY'))
    .setAccessTokenUrl('https://api.twitter.com/oauth/access_token')
    .setAccessToken(PropertiesService.getScriptProperties().getProperty('TWITTER_ACCESS_TOKEN'))
    .setAccessTokenSecret(PropertiesService.getScriptProperties().getProperty('TWITTER_ACCESS_TOKEN_SECRET'))
...
function getFacebookService() {
  return OAuth2.createService('Facebook')
    ...
    .setClientId(PropertiesService.getScriptProperties().getProperty('FACEBOOK_APP_ID'))
    .setClientSecret(PropertiesService.getScriptProperties().getProperty('FACEBOOK_APP_SECRET'))
    .setCallbackFunction('authCallback')
    .setPropertyStore(PropertiesService.getUserProperties())
